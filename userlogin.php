<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $sql = "SELECT * FROM userreg WHERE email = '$myusername' and password = '$mypassword'";
      ...
      if($count == 1) {
         ...
         session_start();  
          ...
          $_SESSION['full_name'] = $row['u_fullname'];  
          $_SESSION['id'] = $row['serial_no'];
          $_SESSION['email'] = $row['email'];
          $_SESSION['contact'] = $row['contact'];
          $_SESSION['designation'] = $row['class'];
...
<body id="page-top" class="index">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a class="page-scroll" href="#page-top">User Login</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
    ...
    <div class="col-sm-6">
        ...
        <!-- <a href="forgetpassword.php" style="float: right;">Forgot Password?</a><br> -->
        <div class="form-group">
...
// $sql = "SELECT * FROM userreg where email=? and password=?";
//             $stmt = $conn->stmt_init();
//             $stmt->prepare($sql);
...
//                 $_SESSION['serial_no']=$resultArray['serial_no'];
//                 //header("Location:userhome.php");
//                 /* Redirect browser */
