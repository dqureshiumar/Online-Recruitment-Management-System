   ...
   <div class="container">
    ...
    <div id="main">
        ...
        // }
            ...
            $designation="";
            $contact="";
            $sql="SELECT * FROM userreg where serial_no=$id" or die($mysqli->error());
            error_reporting(0);
            $stmt = $conn->stmt_init();
            $stmt->prepare($sql);
                        ...
                        <p class="small">
                            <form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST">
                               ...
                               Contact:-<?php echo $contact;?><br>
                                <a href="userupdate.php" class="btn btn-primary">Update Profile</a>
                            </form>
                        </p>
                </div>
            </div>
