   ...
   <div class="container">
    ...
    <div id="main">
        ...
        // }
            ...
            $email="";
            $contact="";
            $sql="SELECT * FROM adminpastejob where id=?" or die($mysqli->error());
                        ...
                        <?php
                            if($_SERVER["REQUEST_METHOD"]=="POST")
                            {
                               ...
                               // $sessionID = session_id();                       
                                $sql="INSERT into final (sessionid ,cateogary, title, company, description, experience, qualification, location, email, contact) values ('$sessionid','$cateogary', '$title', '$company', '$description', '$experience', '$qualification', '$location', '$email', '$contact')";
                              
                                if (mysqli_query($conn,$sql))
                                {
                                    echo "<script>swal('Good','Employee added to wishlist','success').then(() => { window.location.href='final.php'; });</script>";
                                }
                                else
                                {
