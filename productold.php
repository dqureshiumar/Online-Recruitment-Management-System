                    ...
                    <div id="totalamount">
                        ...
                        <?php
                            if($_SERVER["REQUEST_METHOD"]=="POST")
                            {
                                ...
                                $sql="insert into cart (userID, sessionID, productID, quantity, total) values ('$userID', '$sessionID', '$productID', '$quantity', '$total')";
                              
                                if (mysqli_query($conn,$sql))
                                {
                                    echo "<script>swal('Cart','Product added to cart','info').then(() => { window.location.href='product.php'; });</script>";
                                }
                                else
                                {
